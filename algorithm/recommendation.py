...
def get_topk_questions_class(origin_query,query_matrix,query_idf_vector,questions,topk,parent):
    ...
    return list_relevant_questions



def get_topk_questions_title(origin_query,query_matrix,query_idf_vector,questions,topk,parent):
